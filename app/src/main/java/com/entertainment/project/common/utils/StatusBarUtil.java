...
public class StatusBarUtil {
    ...
    public static void setImmersiveStatusBarToolbar(@NonNull Toolbar toolbar, Context context) {
        ...
        toolLayoutParams.height = ScreenUtils.getStatusBarHeight(context) + ScreenUtils.getActionBarSize(context);
        toolbar.setLayoutParams(toolLayoutParams);
        toolbar.setPadding(0, ScreenUtils.getStatusBarHeight(context), 0, 0);
