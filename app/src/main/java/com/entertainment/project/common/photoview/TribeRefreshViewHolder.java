 ...
 */
public class TribeRefreshViewHolder extends BGARefreshViewHolder {
    ...
    private String mReleaseRefreshText = "松开可以刷新";
     ...
     */
    public TribeRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
