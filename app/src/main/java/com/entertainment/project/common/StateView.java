...
public class StateView extends View {
                ...
                public void onClick(View v) {
                    if (mStateViewClickListener != null){
                        ...
                        mEmptyView.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                mStateViewClickListener.onEmptyClick();
                            }
                        }, 200);
                    }
                }
                ...
                public void onClick(View v) {
                    if (mStateViewClickListener != null){
                        ...
                        mRetryView.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                mStateViewClickListener.onRetryClick();
                            }
                        }, 200);
                    }
                }
    ...
    /**
     * 监听重试
     * @param listener {@link OnStateViewClickListener}
     */
    public void setOnRetryClickListener(OnStateViewClickListener listener){
